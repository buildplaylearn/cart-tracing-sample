...
class CustomerCartController(val cartService: CartService) {
    @GetMapping
    ...
    fun addItemCustomerCart(@PathVariable customerId: String, @RequestBody addItemRequest: AddItemRequest): Cart {
        return CartItem(itemId = addItemRequest.itemId, quantity = addItemRequest.quantity)
